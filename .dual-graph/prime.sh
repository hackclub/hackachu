#!/usr/bin/env bash
PORT=$(cat "/home/plastuchino/code/hackachu-codebase/hackachu/.dual-graph/run/claude/mcp_port" 2>/dev/null || echo 8082)
...
if [[ -f "/home/plastuchino/code/hackachu-codebase/hackachu/CONTEXT.md" ]]; then
  echo ""
  echo "=== CONTEXT.md ==="
  cat "/home/plastuchino/code/hackachu-codebase/hackachu/CONTEXT.md"
  echo "=== end CONTEXT.md ==="
fi
# Inject AUDIT_CONTEXT.md if recent (< 7 days) — tells Claude what to fix
AUDIT_CTX="/home/plastuchino/code/hackachu-codebase/hackachu/.dual-graph/AUDIT_CONTEXT.md"
if [[ -f "$AUDIT_CTX" ]]; then
...
STORE="/home/plastuchino/code/hackachu-codebase/hackachu/.dual-graph/context-store.json"
